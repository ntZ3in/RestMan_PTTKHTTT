package RestMan.View.Form.Customer_Form;

import RestMan.Controller.Service.ServiceCustomer;
import RestMan.Model.ModelKhachHang;
...
import RestMan.View.Main_Frame.Main_Customer_Frame;
...
public class AccountC_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtmaKH = new RestMan.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenKH = new javax.swing.JLabel();
        txttenKH = new RestMan.View.Swing.MyTextField();
        lbngayTG = new javax.swing.JLabel();
        lbdso = new javax.swing.JLabel();
        txtdso = new RestMan.View.Swing.MyTextField();
        lbdTL = new javax.swing.JLabel();
        txtdiemtl = new RestMan.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        txtngayTG = new RestMan.View.Swing.MyTextField();
    ...
    private RestMan.View.Swing.MyTextField txtdiemtl;
    private RestMan.View.Swing.MyTextField txtdso;
    private RestMan.View.Swing.MyTextField txtemail;
    private RestMan.View.Swing.MyTextField txtmaKH;
    private RestMan.View.Swing.MyPasswordField txtmatkhau;
    private RestMan.View.Swing.MyTextField txtngayTG;
    private RestMan.View.Swing.MyTextField txtrole;
    private RestMan.View.Swing.MyTextField txttenKH;
