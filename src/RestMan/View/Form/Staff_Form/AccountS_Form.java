package RestMan.View.Form.Staff_Form;

import RestMan.Controller.Service.ServiceStaff;
import RestMan.Model.ModelNhanVien;
import RestMan.Model.ModelNguoiDung;
import RestMan.View.Dialog.MS_ChangePassword;
import RestMan.View.Dialog.MS_ConfirmRename;
import RestMan.View.Main_Frame.Main_Staff_Frame;
...
private MS_ChangePassword changepass;
    ...
    private void initComponents() {
        ...
        pic = new RestMan.View.Swing.ImageAvatar();
        lbmaNV = new javax.swing.JLabel();
        txtngVL = new RestMan.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenNV = new javax.swing.JLabel();
        txttenNV = new RestMan.View.Swing.MyTextField();
        lbngVL = new javax.swing.JLabel();
        lbCvu = new javax.swing.JLabel();
        txtCvu = new RestMan.View.Swing.MyTextField();
        lbNQL = new javax.swing.JLabel();
        txtMaNQL = new RestMan.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lbEmail = new javax.swing.JLabel();
        txtemail = new RestMan.View.Swing.MyTextField();
        lbmk = new javax.swing.JLabel();
        txtmatkhau = new RestMan.View.Swing.MyPasswordField();
        jSeparator2 = new javax.swing.JSeparator();
        cmdDMK = new RestMan.View.Swing.Button();
        lbRole = new javax.swing.JLabel();
        txtrole = new RestMan.View.Swing.MyTextField();
        txtSDT = new RestMan.View.Swing.MyTextField();
        lbSDT = new javax.swing.JLabel();
        txtmaNV = new RestMan.View.Swing.MyTextField();
    ...
    private RestMan.View.Swing.Button cmdDMK;
    ...
    private RestMan.View.Swing.ImageAvatar pic;
    private javax.swing.JLabel titleKH;
    private javax.swing.JLabel titleND;
    private RestMan.View.Swing.MyTextField txtCvu;
    private RestMan.View.Swing.MyTextField txtMaNQL;
    private RestMan.View.Swing.MyTextField txtSDT;
    private RestMan.View.Swing.MyTextField txtemail;
    private RestMan.View.Swing.MyTextField txtmaNV;
    private RestMan.View.Swing.MyPasswordField txtmatkhau;
    private RestMan.View.Swing.MyTextField txtngVL;
    private RestMan.View.Swing.MyTextField txtrole;
    private RestMan.View.Swing.MyTextField txttenNV;
