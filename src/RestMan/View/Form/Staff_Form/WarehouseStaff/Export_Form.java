...
public class Export_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtslPXK = new RestMan.View.Swing.MyTextField();
        lbPXK = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePXK = new RestMan.View.Swing.Table();
        cmdAdd = new RestMan.View.Swing.Button();
        cmdCT = new RestMan.View.Swing.Button();
    ...
    private RestMan.View.Swing.Button cmdCT;
    ...
    private RestMan.View.Swing.Table tablePXK;
    private RestMan.View.Swing.MyTextField txtSearch;
    private RestMan.View.Swing.MyTextField txtslPXK;
