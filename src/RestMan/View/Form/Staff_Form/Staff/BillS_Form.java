package RestMan.View.Form.Staff_Form.Staff;

import RestMan.Controller.Service.ServiceCustomer;
import RestMan.Controller.Service.ServiceStaff;
import RestMan.Model.ModelBan;
import RestMan.Model.ModelCTHD;
import RestMan.Model.ModelHoaDon;
import RestMan.Model.ModelNguoiDung;
import RestMan.Model.ModelNhanVien;
import RestMan.View.Dialog.MS_PaymentSuccess;
import RestMan.View.Dialog.MS_Success;
import RestMan.View.Form.MainForm;
import RestMan.View.Main_Frame.Main_Admin_Frame;
import RestMan.View.Swing.CustomScrollBar.ScrollBarCustom;
...
public class BillS_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bg = new RestMan.View.Swing.PanelRound();
        lbTitle = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        cmdOK = new RestMan.View.Swing.ButtonOutLine();
        cmdCancel = new RestMan.View.Swing.ButtonOutLine();
        lbNgHD = new javax.swing.JLabel();
        txtidHD = new RestMan.View.Swing.MyTextField();
        lbidHD = new javax.swing.JLabel();
        jSeparator3 = new javax.swing.JSeparator();
        cmdExportBill = new RestMan.View.Swing.Button();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableCTHD = new RestMan.View.Swing.Table();
        lbTienmonan = new javax.swing.JLabel();
        txtTienmonan = new RestMan.View.Swing.MyTextField();
        lbTiengiam = new javax.swing.JLabel();
        txtTiengiam = new RestMan.View.Swing.MyTextField();
        lbTongtien = new javax.swing.JLabel();
        txtTongtien = new RestMan.View.Swing.MyTextField();
        lbTienKH = new javax.swing.JLabel();
        txtTienKH = new RestMan.View.Swing.MyTextField();
        lbTientra = new javax.swing.JLabel();
        txtTientra = new RestMan.View.Swing.MyTextField();
        lbidKH = new javax.swing.JLabel();
        txtidKH = new RestMan.View.Swing.MyTextField();
    ...
    private RestMan.View.Swing.PanelRound bg;
    private RestMan.View.Swing.ButtonOutLine cmdCancel;
    private RestMan.View.Swing.Button cmdExportBill;
    private RestMan.View.Swing.ButtonOutLine cmdOK;
    ...
    private RestMan.View.Swing.Table tableCTHD;
    private RestMan.View.Swing.MyTextField txtTienKH;
    private RestMan.View.Swing.MyTextField txtTiengiam;
    private RestMan.View.Swing.MyTextField txtTienmonan;
    private RestMan.View.Swing.MyTextField txtTientra;
    private RestMan.View.Swing.MyTextField txtTongtien;
    private RestMan.View.Swing.MyTextField txtidHD;
    private RestMan.View.Swing.MyTextField txtidKH;
