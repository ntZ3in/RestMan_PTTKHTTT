package RestMan.Controller.Service;

import RestMan.Controller.Connection.DatabaseConnection;
import RestMan.Model.ModelChart;
import RestMan.Model.ModelHoaDon;
import RestMan.Model.ModelMonAn;
import RestMan.Model.ModelNhanVien;
import RestMan.Model.ModelPNK;
...
public class ServiceAdmin {
    ...
    public ArrayList<ModelNhanVien> getListNV() throws SQLException {
        ...
        String sql = "SELECT ID_NV,TenNV,DATE_FORMAT(NgayVL,'dd-mm-yyyy')as Ngay,SDT,ChucVu,ID_NQL,TinhTrang FROM NhanVien";
    ...
    public ModelNhanVien getNV(int idNV) throws SQLException {
        ...
        String sql = "SELECT ID_NV,TenNV,DATE_FORMAT(NgayVL,'dd-mm-yyyy')as Ngay,SDT,ChucVu,ID_NQL,TinhTrang FROM NhanVien WHERE ID_NV=?";
        PreparedStatement p = con.prepareStatement(sql);
        p.setInt(1, idNV);
        ResultSet r = p.executeQuery();
        while (r.next()) {
    ...
    public ArrayList<ModelHoaDon> getListHDIn(String txt) throws SQLException {
        ...
        String sql = "SELECT ID_HoaDon,ID_KH,ID_Ban,DATE_FORMAT(NgayHD,'dd-mm-yyyy') as Ngay,Tienmonan,Tiengiam,Tongtien FROM HoaDon";
        if (txt.equals("Tất cả")) {
            sql = "SELECT ID_HoaDon,ID_KH,ID_Ban,DATE_FORMAT(NgayHD,'dd-mm-yyyy') as Ngay,Tienmonan,Tiengiam,Tongtien FROM HoaDon";
        } else if (txt.equals("Hôm nay")) {
            sql = "SELECT ID_HoaDon,ID_KH,ID_Ban,DATE_FORMAT(NgayHD,'dd-mm-yyyy') as Ngay,Tienmonan,Tiengiam,Tongtien FROM HoaDon "
                    + "WHERE STR_TO_DATE(NgayHD,'dd-mm-yyyy')=STR_TO_DATE(CURRENT_DATE,'dd-mm-yyyy')";
    ...
    public int getRevenueHD(String filter) throws SQLException {
        ...
        String sql = "SELECT SUM(Tongtien) FROM HoaDon WHERE STR_TO_DATE(NgayHD,'dd-mm-yyyy')=STR_TO_DATE(CURRENT_DATE,'dd-mm-yyyy')";
        if(filter.equals("Hôm nay")){
            sql = "SELECT SUM(Tongtien) FROM HoaDon WHERE STR_TO_DATE(NgayHD,'dd-mm-yyyy')=STR_TO_DATE(CURRENT_DATE,'dd-mm-yyyy')";
    ...
    public ArrayList<ModelPNK> getListPNKIn(String txt) throws SQLException {
        ...
        String sql = "SELECT ID_NK,ID_NV,DATE_FORMAT(NgayNK,'dd-mm-yyyy') AS Ngay,Tongtien FROM PhieuNK ORDER BY ID_NK";
        if (txt.equals("Tất cả")) {
            sql = "SELECT ID_NK,ID_NV,DATE_FORMAT(NgayNK,'dd-mm-yyyy') AS Ngay,Tongtien FROM PhieuNK ORDER BY ID_NK";
        } else if (txt.equals("Hôm nay")) {
            sql = "SELECT ID_NK,ID_NV,DATE_FORMAT(NgayNK,'dd-mm-yyyy') AS Ngay,Tongtien FROM PhieuNK "
                    + "WHERE STR_TO_DATE(NgayNK,'dd-mm-yyyy')=STR_TO_DATE(CURRENT_DATE,'dd-mm-yyyy') ORDER BY ID_NK";
        } else if (txt.equals("Tháng này")) {
            sql = "SELECT ID_NK,ID_NV,DATE_FORMAT(NgayNK,'dd-mm-yyyy') AS Ngay,Tongtien FROM PhieuNK "
    ...
    public int getCostNK(String filter) throws SQLException {
        ...
        String sql = "SELECT SUM(Tongtien) FROM PhieuNK WHERE STR_TO_DATE(NgayNK,'dd-mm-yyyy')=STR_TO_DATE(CURRENT_DATE,'dd-mm-yyyy')";
        if(filter.equals("Hôm nay")){
            sql = "SELECT SUM(Tongtien) FROM PhieuNK WHERE STR_TO_DATE(NgayNK,'dd-mm-yyyy')=STR_TO_DATE(CURRENT_DATE,'dd-mm-yyyy')";
        }else if(filter.equals("Tháng này")){
